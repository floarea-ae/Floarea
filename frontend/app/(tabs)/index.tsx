    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity testID="hero-banner" style={styles.heroBanner} onPress={() => router.push('/shop')} activeOpacity={0.9}>
          <Image
            source={{ uri: 'https://static.prod-images.emergentagent.com/jobs/a06552a2-c265-40ba-8f47-09377686258f/images/7a38dfc4f58944083838abb9587b764e9809560d2e9979a74da00d8440727956.png' }}
        ...
        {/* Promo Banner */}
        <TouchableOpacity style={styles.promoBanner} onPress={() => router.push('/shop')} activeOpacity={0.9}>
          <Image
            source={{ uri: 'https://static.prod-images.emergentagent.com/jobs/a06552a2-c265-40ba-8f47-09377686258f/images/bb43e32f1de35ccdae4ff274e261cafb9eec619a1fdfd82effeb85a816e39db2.png' }}
...
const styles = StyleSheet.create({
  ...
  heroBtn: {
    backgroundColor: COLORS.white, paddingHorizontal: 24, paddingVertical: 14,
  ...
  catName: { fontFamily: FONTS.heading, fontSize: 18, color: COLORS.white },
  ...
  promoBtn: {
    borderWidth: 1, borderColor: COLORS.white, paddingHorizontal: 20, paddingVertical: 12,
